...
import { BREADCRUMBS_LINKS, QueryParams } from '../../../const';
...
const CATALOGUE_PAGE_BREADCRUMBS = [BREADCRUMBS_LINKS.main, BREADCRUMBS_LINKS.catalogue];
...
function CataloguePage(): JSX.Element {
  ...
  return (
    <MainLayout>
      ...
      <Breadcrumbs breadcrumbs={CATALOGUE_PAGE_BREADCRUMBS} />
